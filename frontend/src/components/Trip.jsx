...
function Trip() {
    ...
    const [travelerType, setTravelerType] = useState("medium"); // Default traveler type
    ...
    const budgetLimits = {
        luxury: Infinity, // No limit for luxury travelers
        medium: 200,
        budget: 100,
    };
    ...
    // Handle form submission for adding or updating a trip
const handleSubmit = async (e) => {
    ...
    if (selectedEndDate < currentDate) {
        alert("You cannot add a trip that has already ended.");
        return;
    }
